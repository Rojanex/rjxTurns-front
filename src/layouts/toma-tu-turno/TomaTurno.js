...
import { Grid, Table, TableRow, TableCell, Box, Button } from "@mui/material";
...
function TomaTurno({ transparent, light, action }) {
      ...
      <Box xs={{ display: "flex", flexDirection: "row" }}>
        <Button
          ...
          sx={{
            mt: 1,
            mb: 1,
            backgroundColor: "#19A4E4", // replace with your desired blue color
        ...
        >
          <MDTypography variant="text" fontWeight="small" color="black" /> Toma
          tu turno
        </Button>
      </Box>
    </CoverLayoutMonitor>
